...
job2_pos = job_pos + margin
location_pos = job2_pos + margin
...
def IDCardGen(image, name, name2, job, job2, location):
    ...
    d.text((safe_guide, job2_pos), job2.upper(), font=font, fill=("#f6f6f6"), strokeWidth=100)
...
for i in gen_list:
    IDCardGen((i["Name"]+".jpg"), i["Name 1"], i["Name 2"], i["Title"], i["Title 2"], location)
